            ...
            <div className="flex items-start space-x-4 mb-8">
              ...
              <div className="flex-1">
                <div className="bg-white rounded-2xl p-4 shadow-sm text-center">
                  <div className="font-bold mb-1 text-4xl text-center">👋我是你的包装设计助手</div>
                  <div className="flex items-center font-bold justify-center">
                    <span className="text-3xl text-center">我们现在来一键生成设计图吧</span>
                    <span className="ml-1 text-3xl text-center">🚀</span>
                  </div>
                </div>
              </div>
            </div>
